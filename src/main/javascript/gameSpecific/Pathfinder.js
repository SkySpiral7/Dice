 ...
 * @return (from calling draw) an object with the keys CardName, Alignment, and Effect
 */
Pathfinder.HarrowDeckOfManyThings = new CustomDice.CustomDie([
   {CardName: 'The Avalanche', Alignment: 'LE', Effect: 'The character becomes the focal point of an earthquake, as per the earthquake spell. In addition to saving versus this effect, the character must succeed at an additional Will save or be affected by the spell imprisonment.'},
   {CardName: 'The Bear', Alignment: 'N', Effect: 'The character gains the lycanthrope template, becoming a werebear lycanthrope, and as such, remove disease and heal have no affect on this affliction.'},
   {CardName: 'The Beating', Alignment: 'NE', Effect: 'While in combat, the character is always considered to be flanked. Attackers gain a +2 flanking bonus on attacks made against the character and may sneak attack him at will.'},
   {CardName: 'The Betrayal', Alignment: 'NE', Effect: 'The character\'s animal companion, familiar, cohort, or other NPC ally is alienated and forever after hostile. If the character has no such allies, the enmity of some powerful personage, community, or religious order can be substituted. This hatred remains a secret until such a time that it might be most dramatically and perilously revealed. Upon drawing this card, the character knows that someone or something will turn against him, but nothing more.'},
   {CardName: 'The Big Sky', Alignment: 'CG', Effect: 'Once per day, the character can add +10 to his CMB or CMD for 1 round. When he does so, a piece of metal in close proximity shatters.'},
   {CardName: 'The Brass Dwarf', Alignment: 'LN', Effect: 'The character becomes immune to one energy type of his choice, but gains vulnerability to another energy type of the GM\'s choice.'},
   {CardName: 'The Carnival', Alignment: 'CN', Effect: 'Upon drawing The Carnival, the card is set aside and the GM draws nine additional cards from the deck. These cards are laid face up for the character to view, then flipped over and shuffled by the GM. The player draws one card from the nine, taking that card\'s effects as normal.'},
   {CardName: 'The Courtesan', Alignment: 'CN', Effect: 'The character\'s favorite item—preferably a magic weapon—becomes intelligent. Use the rules for intelligent items to randomly generate the item\'s abilities. If the character has no items, an intelligent item soon falls into the character\'s possession.'},
   {CardName: 'The Cricket', Alignment: 'NG', Effect: 'Upon drawing this card, the character may choose to draw up to three additional cards. In addition to those cards\' effects, the character\'s base land speed increases by +10 feet for each card he draws.'},
   {CardName: 'The Crows', Alignment: 'NE', Effect: 'The character must choose between his most valuable item and a major ally of the GM\'s choice. Whichever is not selected is destroyed or slain and cannot be restored by mortal means. The character is made aware of the ramifications of this choice upon drawing the card.'},
   {CardName: 'The Cyclone', Alignment: 'CE', Effect: 'An elder air elemental appears, and the character must fight it alone. If the character cannot defeat the elemental in 1d6+1 rounds, he is transported to the Plane of Air.'},
   {CardName: 'The Dance', Alignment: 'LG', Effect: 'From this point on, whenever the character rolls initiative, he rolls twice and selects whichever result he prefers.'},
   {CardName: 'The Demon\'s Lantern', Alignment: 'CE', Effect: 'The character\'s body disintegrates. All that remains are his items and a glowing gem containing his soul. This gem is worth an amount of gp equal to 2,500 × the character\'s level. A resurrection or stronger spell is required to restore the character, and doing so destroys the gem.'},
   {CardName: 'The Desert', Alignment: 'CG', Effect: 'This card grants the character the one-time ability to travel to any location on the same plane instantly, bringing with him up to 10 allies and 2,000 pounds of goods. The character must know exactly where he wishes to travel, such as a place he has been or a location on a map, but not a vague or hidden location, like the richest dungeon in the world or the Lost City of Ird. This transportation ignores all barriers against teleportation or other magical effects. The character may use this card\'s effect whenever he wishes, but only once.'},
   {CardName: 'The Fiend', Alignment: 'LE', Effect: 'A powerful evil outsider takes notice of the character and sets plans in motion to destroy him.'},
   {CardName: 'The Foreign Trader', Alignment: 'N', Effect: 'The mysterious entity known as the Foreign Trader appears and offers the character any treasure he wishes in return for years of his life. If the character accepts, he must choose to age a number of age categories. The character takes all the ability score penalties for his new age, but gains none of the benefits. For each age category he advances, however, he gains 20,000 gp worth of credit with the Foreign Trader, which can be spent on any non-unique magic items. Any credit a character does not spend is lost. After the character is done spending his credit, the Foreign Trader vanishes. Years taken by the Foreign Trader cannot be restored by any means. The Foreign Trader does not trade with characters who cannot die of old age. If the character is immortal, the Foreign Trader vanishes, leaving behind another card. If the character declines to bargain with the Foreign Trader, the trader disappears in a puff of acrid yellow smoke.'},
   {CardName: 'The Forge', Alignment: 'LN', Effect: 'The character must choose one weapon or armor in his possession to be reforged into another weapon or armor of equal or lesser gp value. For example, should a character choose to have a +3 longsword (an 18,315 gp value) reforged, he could have it transformed into any one of hundreds of items, like a +1 axiomatic scimitar (also a 18,315 gp value) or a suit of +3 full-plate of silent moves (12,300 gp). Any gp value not spent is lost.'},
   {CardName: 'The Eclipse', Alignment: 'LE', Effect: 'From the hours of dusk to dawn, the character is treated as being one level lower than normal. If the character has multiple classes, he must decide upon drawing this card which class is affected.'},
   {CardName: 'The Empty Throne', Alignment: 'LG', Effect: 'The character inherits a noble title and 15,000 gp soon after drawing this card. The GM decides the particulars of when and how this occurs.'},
   {CardName: 'The Hidden Truth', Alignment: 'LG', Effect: 'This card grants the character the one-time ability to call upon an omniscient spirit to fully answer any question or solve any single puzzle. Whether the information revealed can be effectively acted upon is another question entirely. The character may use this card\'s effect whenever he wishes, but only once.'},
   {CardName: 'The Idiot', Alignment: 'NE', Effect: 'The character\'s Charisma, Intelligence, and Wisdom scores are all reduced by 1d4 points. Roll individually for each ability score.'},
   {CardName: 'The Inquisitor', Alignment: 'LN', Effect: 'This card grants the character the one-time ability to force another creature to answer a single question truthfully. The card does not grant the character or creature questioned any special insight, so a creature might still answer a question falsely if it believes the falsehood. If the creature is truly ignorant, it informs the character that it doesn\'t know the answer and this effect is wasted. The character may use this card\'s effect whenever he wishes, but only once.'},
   {CardName: 'The Joke', Alignment: 'CG', Effect: 'Upon drawing this card, the character selects one of his allies. Three new cards are then drawn by the GM and made visible (the GM may choose whether or not to explain the cards\' effects). The character\'s ally must choose one of these cards and immediately gains the effects. The character then selects one of the remaining two cards and gains that card\'s effects. The final card is discarded.'},
   {CardName: 'The Juggler', Alignment: 'CG', Effect: 'The character gains a +2 bonus to two ability scores of his choice, but must swap them with one another.'},
   {CardName: 'The Keep', Alignment: 'NG', Effect: 'The character gains a personal demiplane, as per a permanent create demiplane spell.'},
   {CardName: 'The Liar', Alignment: 'CE', Effect: 'The character\'s most powerful, most valuable, or favorite magic item (GM\'s choice) manifests a curse. Roll on Table: Common Item Curses to generate this effect, rerolling results for specific items.'},
   {CardName: 'The Locksmith', Alignment: 'LN', Effect: 'This card grants the character the ability to open any one door, lock, set of bindings, or other locked barrier. This includes magical gates or portals that have specific requirements to activate. The character may use this card\'s effect whenever he wishes, but only once. Once used, the card\'s effect ends.'},
   {CardName: 'The Lost', Alignment: 'CE', Effect: 'The character cannot gain another level in whichever class he currently has the most levels. This effect can be circumvented if the character is killed and returned to life, but the next time he is restored to life he is affected as if by the spell reincarnate, regardless of what spell was cast.'},
   {CardName: 'The Marriage', Alignment: 'LN', Effect: 'A comely genie of the character\'s preferred gender appears and proposes marriage. Should the character accept, he must organize a lavish wedding ceremony by the end of the week and ever after be committed to this exotic outsider. If the character declines or breaks his wedding vow, the genie is heartbroken and returns to his or her home plane, provoking the ire of the associated elemental court. The genie\'s type, personality, actions, and possible retribution are determined by the GM.'},
   {CardName: 'The Midwife', Alignment: 'NG', Effect: 'The character gains exactly enough experience to advance to the next level.'},
   {CardName: 'The Mountain Man', Alignment: 'CN', Effect: 'The character grows one size category, gaining all the benefits and penalties of increased size. His equipment does not increase in size.'},
   {CardName: 'The Mute Hag', Alignment: 'NE', Effect: 'The character permanently loses one of his senses—sight, hearing, or speech—becoming blind, deaf, or mute (player\'s choice). This affliction cannot be cured by any effect short of a miracle or wish spell.'},
   {CardName: 'The Owl', Alignment: 'N', Effect: 'This card grants the character the one-time ability to scry on any target anywhere for 1 minute. The target, however, is immediately aware that it is being scryed upon by the character. The character may use this card\'s effect whenever he wishes, but only once. Once used, the card\'s effect ends.'},
   {CardName: 'The Paladin', Alignment: 'LG', Effect: 'The character is granted a holy avenger. This weapon has all the properties of a normal holy avenger, along with a special ability that can be used once. Upon being thrust into the ground by its bearer as a standard action, the weapon transforms into a paladin two levels higher than the wielder. This paladin possesses her own holy avenger and aids the character in any way her alignment permits for 30 minutes. Once this time is over, the paladin vanishes and the sword reappears, though it is forever reduced to a +2 cold iron longsword.'},
   {CardName: 'The Peacock', Alignment: 'N', Effect: 'The character\'s skin hardens, becoming rigid and pebbled. He gains a permanent +2 bonus to his natural armor, but takes a -2 penalty to Dexterity.'},
   {CardName: 'The Publican', Alignment: 'CG', Effect: 'The GM chooses one of the character\'s enemies. This enemy has a complete change of heart and now favors the character.'},
   {CardName: 'The Queen Mother', Alignment: 'LN', Effect: 'When the character draws this card, 2d4 giant ants appear to serve the character until they are slain. These creatures eagerly seek to aid and protect the character. They understand the character\'s verbal commands, though they cannot respond.'},
   {CardName: 'The Rabbit Prince', Alignment: 'CN', Effect: 'All attacks the character makes that threaten a critical hit are automatically confirmed. Likewise, all attacks made against the character that threaten a critical hit are also automatically confirmed.'},
   {CardName: 'The Rakshasa', Alignment: 'LE', Effect: 'Anytime the character lies with the true intent to deceive, he turns into a random animal for 1 hour. Lying with the intent to trigger this effect never works.'},
   {CardName: 'The Sickness', Alignment: 'NE', Effect: 'The character becomes afflicted with incurable leprosy (or another disease of the GM\'s choice). While the disease cannot be cured by any effect short of a miracle or wish spell, the effects of the affliction can be negated through the use of spells like restoration.'},
